...
#ChangeType = 'InverseSubtract'
ChangeType = 'LinearToInverse'
PathContents = PathToLifetimePredictions.split('/')
PathToKrLifetimeFile = '/'.join(PathContents[:-1]) + '/Kr83m/Kr_' + PathContents[-1]
#PathToKrLifetimeFile = 'MCMC_Results/TXTs/Kr83m/Kr_Prediction_180104sr0onlys_updated_correction_180108.txt'

ChangeVal, ChangeValErr = FormPars.GetKrCorrection(ChangeType)
