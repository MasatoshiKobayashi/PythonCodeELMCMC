...
#Rn222ELifeDataFile   = '/home/kobayashi1/work/xenon/analysis/ElectronLifetime/ElectronLifetime/FitData/Lifetimes/ElectronLifetimeDataWithRn222_good_hax_tags.txt'
#Po218ELifeDataFile   = '/home/kobayashi1/work/xenon/analysis/ElectronLifetime/ElectronLifetime/FitData/Lifetimes/ElectronLifetimeDataWithPo218_good_hax_tags.txt'
...
#Rn222ELifeDataFile   = '/home/kobayashi1/work/xenon/analysis/ElectronLifetime/ElectronLifetime/FitData/Lifetimes/old/pre_time_dependent_3d_fdc/ElectronLifetimeDataWithRn222.txt'
#Po218ELifeDataFile   = '/home/kobayashi1/work/xenon/analysis/ElectronLifetime/ElectronLifetime/FitData/Lifetimes/old/pre_time_dependent_3d_fdc/ElectronLifetimeDataWithPo218.txt'
#Rn220ELifeDataFile   = '/home/kobayashi1/work/xenon/analysis/ElectronLifetime/ElectronLifetime/FitData/Lifetimes/old/pre_time_dependent_3d_fdc/ElectronLifetimeDataWithRn220.txt'
...
#                   color = 'gold',
    ...
    if ShowResiduals and PlotRnEvolution:
        try:
          ax2.hlines(0, min(Dates2), max(Dates2), color='deeppink', linewidth=6)
          ax2.fill_between(
                                   Dates2,
...
if PlotPoRn:
    ax.errorbar(PoRnDates, PoRnELifeValues,  xerr = [PoRnDateErrorLowers,PoRnDateErrorUppers],
                ...
                marker='v', label='$\\rm{^{218}Po}/^{222}Rn}$', elinewidth=2)
if PlotRn220:
    ax.errorbar(Rn220Dates, Rn220ELifeValues,  xerr = [Rn220DateErrorLowers,Rn220DateErrorUppers],
                ...
                marker='v', markersize=8, label='$\\rm{^{212}Bi}\,\,\, 6.207\,\, MeV$', elinewidth=2)
...
if PlotRn222:
    ax.errorbar(Rn222Dates, Rn222ELifeValues,  xerr = [Rn222DateErrorLowers,Rn222DateErrorUppers],
                ...
                marker='v', markersize=8, label='$\\rm{^{222}Rn}\,\,\, 5.590\,\, MeV$', elinewidth=2)
...
if XLimStart == 'SR0' and XLimLow is None:
    XLimLow = dt.datetime.fromtimestamp(ScienceRunUnixtimes['SR0'][0] - 5*24.*3600)
if XLimStart == 'SR1' and XLimLow is None:
    XLimLow = dt.datetime.fromtimestamp(ScienceRunUnixtimes['SR1'][0] - 5*24.*3600)
if XLimEnd == 'SR1' and XLimUp is None:
    XLimUp = dt.datetime.fromtimestamp(ScienceRunUnixtimes['SR1'][0] - 5*24.*3600)
elif XLimUp is None:
...
#XLimUp = dt.datetime.fromtimestamp(LastPointUnixtime-20*3600.*24.)
...
#            TextOffsetEndRun = 450
        ...
        StartUnixtime=ScienceRunUnixtimes[ScienceRun][0]
        EndUnixtime=ScienceRunUnixtimes[ScienceRun][1]
        if dt.datetime.fromtimestamp(StartUnixtime) > XLimLow and dt.datetime.fromtimestamp(StartUnixtime) < XLimUp:
        # start of science run
            ax.axvline( x=dt.datetime.fromtimestamp(StartUnixtime),
                                ymin = 0,
                                ymax = 1, 
                                linestyle = "--",
                                linewidth=3,
            ...
            ax.text( 
                        dt.datetime.fromtimestamp(StartUnixtime + 2*24*3600), 
                        TextOffsetStartRun, 
        ...
        # end of science run
        if dt.datetime.fromtimestamp(EndUnixtime) > XLimLow and dt.datetime.fromtimestamp(EndUnixtime) < XLimUp:
            ax.axvline( x=dt.datetime.fromtimestamp(EndUnixtime),
                                ymin = 0,
                                ymax = 1, 
                                linestyle = "--",
                                linewidth=3,
            ...
            ax.text( 
                        dt.datetime.fromtimestamp(EndUnixtime - 4*24*3600), 
                        TextOffsetEndRun, 
        ...
        if ShowResiduals:
          if dt.datetime.fromtimestamp(StartUnixtime) > XLimLow and dt.datetime.fromtimestamp(StartUnixtime) < XLimUp:
                ax2.axvline( x=dt.datetime.fromtimestamp(StartUnixtime),
                                    ymin = 0,
                                    ymax = 1, 
                                    linestyle = "--",
                                    linewidth=3,
          ...
          if dt.datetime.fromtimestamp(EndUnixtime) > XLimLow and dt.datetime.fromtimestamp(EndUnixtime) < XLimUp:
                ax2.axvline( x=dt.datetime.fromtimestamp(EndUnixtime),
                                    ymin = 0,
                                    ymax = 1, 
                                    linestyle = "--",
                                    linewidth=3,
          ...
          if PlotOperations:
              ...
              for Operation,Info in Operations.items():
                  ...
                  if DrawOpLines:
                      ax2.axvline(
                          x=dt.datetime.fromtimestamp(Info['unixtime']),
                          ymin = 0,
                          ymax = 1, 
    ...
    for Operation,Info in Operations.items():
        ...
        if PrintOpText:
            ...
            if Info['y'] == 'top':
                ...
                y = Info['y']
            ax.text(
                dt.datetime.fromtimestamp(Info['unixtime'] + Info['print_text_after']*3600.*24),
                y,
                Info['text'],
                color=Info['color'],
                size=Info['size'],
...
#                dt.datetime.fromtimestamp(1496685600), 
#                700., 
#                'Gate Washing',
#                color='m',
#                size=22.,
...
#axtwint = ax.twinx()
#axtwins = ax.twinx()
#slowControl = pickle.load(open('/home/kobayashi1/work/xenon/analysis/ElectronLifetime/SlowControl/PickleFiles/ImpurityUpdated_160501_to_180619.pkl', 'rb'))
#dsTPC = [datetime.datetime.fromtimestamp(ui) for ui in slowControl['TPC_Monitor_Voltage']['unixtimes']]
#dsCRY113 = [datetime.datetime.fromtimestamp(ui) for ui in slowControl['CRY_TE113']['unixtimes']]
#dsCRY104 = [datetime.datetime.fromtimestamp(ui) for ui in slowControl['CRY_TE104']['unixtimes']]
#axtwin.plot(
#    dsTPC,
...
plt.savefig(FigureSaveName+'_'+XLimStart+ResidEnding+FigEnding+'.png', format='png')
plt.savefig(FigureSaveName+'_'+XLimStart+ResidEnding+FigEnding+'.pdf', format='pdf')
