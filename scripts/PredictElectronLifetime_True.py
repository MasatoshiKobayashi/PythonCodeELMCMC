...
PredictionOutputFile = sys.argv[3] + "_True"
...
FileParams = '/dali/lgrandi/kobayashi1/xenon/analysis/ElectronLifetime/ElectronLifetime/PythonCodeELMCMCndna_semi_final23_6/TEMP_Param.txt'
...
Pars_Trials = PickupMCMCPosteriors(samples_cut, NumOfTrials)
#print(UnixTimes)
Trends,TrendsImpurityGXe,TrendsImpurityLXe,Nlost=Randomize_True(UnixTimes,Pars_Trials)
